...
export function BbbAccreditedSection() {
  return (
    <section
      id="bbb-accredited"
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:items-center">
          <div className="border border-[#e4ad42]/45 bg-[#1f2124] p-6 shadow-[0_18px_42px_rgba(0,0,0,0.35)]">
            ...
            <p className="mt-3 leading-7 text-[#dddddd]">
              ...
              Painting Inc. will repair any areas where peeling, blistering, or
              chipping occurs as a direct result of defective workmanship.
            </p>
            <Link
